...
public class FSBInterop {
    ...
    private void generateSky(String dimension, String type) {
        ...
        SkyboxManager.getInstance().addSkybox(new Identifier("fabricskyboxes-interop", "overworld"), json);
    ...
    private void generateOverworldDecorations() {
        ...
        SkyboxManager.getInstance().addSkybox(new Identifier("fabricskyboxes-interop", "overworld-decorations"), json);
